...
inline void keep_alive_impl(handle nurse, handle patient, size_t placement) {
...
PYBIND11_NOINLINE inline void keep_alive_impl(size_t Nurse, size_t Patient, size_t placement, function_call &call, handle ret) {
